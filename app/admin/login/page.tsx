    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div className="mb-6">
          ...
          <p className="text-center text-gray-700 font-medium text-sm mt-2">Admin & Staff Login</p>
        </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-700 hover:text-gray-900 focus:outline-none font-medium"
              >
                {showPassword ? (
