...
const BusinessSettingsSchema = new mongoose.Schema({
  ...
  quickLinksEnabled: { type: Boolean, default: true },
  quickLink1Text: { type: String, default: 'Browse Stock' },
  quickLink1Href: { type: String, default: '/' },
  quickLink2Text: { type: String, default: 'Offers' },
  quickLink2Href: { type: String, default: '/offers' },
  quickLink3Text: { type: String, default: 'Orders' },
  quickLink3Href: { type: String, default: '/orders' },
  quickLink4Text: { type: String, default: 'Contact' },
  quickLink4Href: { type: String, default: '/contact' },
  ownerAddress: { type: String, default: '' },
  ownerPhone1: { type: String, default: '' },
  ownerMapLink: { type: String, default: '' },
  storeTiming: { type: String, default: 'Mon-Sat 10am-7pm' },
