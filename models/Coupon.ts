...
const CouponSchema = new mongoose.Schema({
  ...
  targetPrice: { type: Number, default: null }, // For bargain/bidding coupons, the agreed product price
  ...
  type: { type: String, enum: ['referral', 'admin', 'bargain', 'bidding'], default: 'admin' }, // Type of coupon
  user: { type: mongoose.Schema.Types.ObjectId, ref: 'User' }, // Associated user (for referral/bargain/bidding coupons)
